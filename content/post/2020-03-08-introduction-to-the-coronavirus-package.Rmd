...
Using the above country level summary, we can derive the recovery and mortality rates, where:

$$ Recovery ~rate = \frac{Total~ Recovered ~Cases} {Total ~Confirmed ~Cases}, and$$
$$ Mortality ~rate = \frac{Total~ Death ~Cases} {Total ~Confirmed ~Cases}$$
